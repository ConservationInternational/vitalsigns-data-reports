...
all <- Reduce(function(x,y) merge(x, y, all=T),
              list(hh, ag, ffs, hhv, ffs_l, ffs_ym, ffs_ypm, ffs_yw)) %>%
...
```{r}
DT::datatable(all, rownames = F, colnames = c("CTY", "Landscape", "Eplot", "HH", "Household", "Agric", "FFS", "SecV", "FFS Lab", "Yields Maize", "Yields Paddy-Maize", "Yields Weight"))
```
