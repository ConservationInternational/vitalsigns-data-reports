...
```{r}
DT::datatable(all %>% unique, rownames = F, colnames = c("CTY", "Landscape", "Eplot", "HH", "Household", "Agric", "FFS", "SecV", "FFS Lab", "Yields Paddy-Maize", "Yields Weight", "Processed Soils"))
```
